function varargout=rs_imana_110118_new_jorn(what,varargin)
...
switch(what)
    ...
    case 'NC_getInterHemPattern'              % get pattern of correlations for pairs between hemispheres
        % 0. Load data
        D       = rs_imana_110118_new_jorn('PP_studySubset');
        D       = rs_imana_110118_new_jorn('PP_removePair',D);
    ...
    case 'FIG_all'
        subplot(221);
        rs_imana_110118_new_jorn('FIG_inter_splithalf_reliability');
        ylim([0 1]);
        ylabel('Fisher Z')
        xlabel('weeks')
        title('Interhemispheric')
        subplot(222);
        rs_imana_110118_new_jorn('FIG_intraLesioned_splithalf_reliability');
        ylim([0 1]);
        ylabel('Fisher Z')
        xlabel('weeks')
        title('Intrahemispheric Les')
        subplot(223);
        rs_imana_110118_new_jorn('FIG_intraNonlesioned_splithalf_reliability');
        ylim([0 1]);
        ylabel('Fisher Z')
        xlabel('weeks')
        title('Intrahemispheric NonLes')
        subplot(224);
        rs_imana_110118_new_jorn('FIG_splithalf_all');
        ylim([0 1]);
        ylabel('Fisher Z')
        xlabel('weeks')
    ...
    case 'acute_control_patient_effectsize_plot'
        ...
        set(gca,'Box','off'); 
    case 'acute_control_patient_equivalence'
        D = load(fullfile(ppDir,'nc_getThemall.mat')); % _joern
        D  = getrow(D,D.week==1);                                          % Dw needs to be changed manually if you want to look at cross-sectional comparison of other weeks
        numIter = 10000; 
        ...
        PP=[];
        euc_true = [0 1.4]; % Assume true Eucledian distance of 2 
        for k=1:length(euc_true)
            P=[];
            for j=1:numIter
                % Make a new assignment of controls and patients
        ...
        histplot(PP.euc_sim,'split',PP.euc_true,'style_bar1','numcat',50); 
    ...
    case 'FIG_acute_control_patient'
        subplot(3,3,[7 2])
        rs_imana_110118_new_jorn('acute_control_patient_all_connections');
        title ('full connectivity pattern')
        
        subplot(3,3,3)
        rs_imana_110118_new_jorn('acute_control_patient_inter');
        title ('interhemispheric connectivity pattern')
        
        subplot(3,3,6)
        rs_imana_110118_new_jorn('acute_control_patient_intra_les');
        title ('intrahemispheric lesioned connectivity pattern')
        
        subplot(3,3,9)
        rs_imana_110118_new_jorn('acute_control_patient_intra_non');
    ...
    case 'FIG_acute_variability'
        ...
        subplot(3,3,[7 2])
        rs_imana_110118_new_jorn('acute_variability_all');
        title ('full connectivity pattern')
        
        subplot(3,3,3)
        rs_imana_110118_new_jorn('acute_variability_inter');
        title ('interhemispheric')
        
        subplot(3,3,6)
        rs_imana_110118_new_jorn('acute_variability_intra_les');
        title ('intrahemispheric lesioned')
        
        subplot(3,3,9)
        rs_imana_110118_new_jorn('acute_variability_intra_non');
    ...
    case 'FIG_all_week_patient'
        subplot(1,4,1)
        rs_imana_110118_new_jorn('all_distance_patients_longitude_1_4');
        title ('All patients week 1 versus 4')
        
        subplot(1,4,2)
        rs_imana_110118_new_jorn('all_distance_patients_longitude_1_12');
        title ('All patients week 1 versus 12')
        
        subplot(1,4,3)
        rs_imana_110118_new_jorn('all_distance_patients_longitude_1_24');
        title ('All patients week 1 versus 24')
        
        subplot(1,4,4)
        rs_imana_110118_new_jorn('all_distance_patients_longitude_1_52');
    ...
    case 'FIG_inter_week_patient'
        subplot(1,4,1)
        rs_imana_110118_new_jorn('inter_distance_patients_longitude_1_4');
        title ('inter patients week 1 versus 4')
        
        subplot(1,4,2)
        rs_imana_110118_new_jorn('inter_distance_patients_longitude_1_12');
        title ('inter patients week 1 versus 12')
        
        subplot(1,4,3)
        rs_imana_110118_new_jorn('inter_distance_patients_longitude_1_24');
        title ('inter patients week 1 versus 24')
        
        subplot(1,4,4)
        rs_imana_110118_new_jorn('inter_distance_patients_longitude_1_52');
    ...
    case 'FIG_intra_non_week_patient'
        subplot(1,4,1)
        rs_imana_110118_new_jorn('intra_non_distance_patients_longitude_1_4');
        title ('intra non patients week 1 versus 4')
        
        subplot(1,4,2)
        rs_imana_110118_new_jorn('intra_non_distance_patients_longitude_1_12');
        title ('intra non patients week 1 versus 12')
        
        subplot(1,4,3)
        rs_imana_110118_new_jorn('intra_non_distance_patients_longitude_1_24');
        title ('intra non patients week 1 versus 24')
        
        subplot(1,4,4)
        rs_imana_110118_new_jorn('intra_non_distance_patients_longitude_1_52');
    ...
    case 'FIG_intra_les_week_patient'
        subplot(1,4,1)
        rs_imana_110118_new_jorn('intra_les_distance_patients_longitude_1_4');
        title ('intra les patients week 1 versus 4')
        
        subplot(1,4,2)
        rs_imana_110118_new_jorn('intra_les_distance_patients_longitude_1_12');
        title ('intra les patients week 1 versus 12')
        
        subplot(1,4,3)
        rs_imana_110118_new_jorn('intra_les_distance_patients_longitude_1_24');
        title ('intra les patients week 1 versus 24')
        
        subplot(1,4,4)
        rs_imana_110118_new_jorn('intra_les_distance_patients_longitude_1_52');
